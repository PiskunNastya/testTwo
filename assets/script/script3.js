...
var popmaster = (function () {
    ...
    function get_pop_options(pop) {
        ...
        if (pop.type == 'popunder' && FMiKauYpzhc.Browser.popunderAvailable() === false) {
            pop.type = 'tabunder';
        }
    ...
    function check_age_range(pop) {
        ...
        var age_from = 0,
            ...
            age_inverted = false,
            should_show = true,
            current_user_birthday, min_age = 18;
        ...
        if (current_date.getMonth() < current_user_birthday.getMonth() || current_date.getMonth() == current_user_birthday.getMonth() && current_date.getDate() < current_user_birthday.getDate()) {
            years_diff--;
        }
    ...
    function get_current_user_birthday() {
        ...
        try {
            if ($('dayofbirth') && $('monthofbirth') && $('yearofbirth') && $('yearofbirth').get('value') && $('monthofbirth').get('value') && $('dayofbirth').get('value')) {
...
Element.implement({
    countdown: function (options) {
        ...
        var _options, _interval, _milliseconds_str, _seconds_str, _minutes_str, _current_date, _end_date, _output_string;
        self.milliseconds;
        self.seconds;
        self.minutes;
        self.remaining_time;
