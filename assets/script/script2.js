...
! function () {
    ...
    var e = this.typeOf = function (t) {
        ...
        n = (this.instanceOf = function (t, e) {
            if (null == t) return !1;
    ...
    s.prototype.overloadSetter = function (e) {
        ...
        this[t] = e
    }.overloadSetter(), s.prototype.implement = function (t, e) {
        this.prototype[t] = e
    }.overloadSetter();
    var o = Array.prototype.slice;
    Array.convert = function (t) {
        return null == t ? [] : a.isEnumerable(t) && "string" != typeof t ? "array" == e(t) ? t : o.call(t) : [t]
        ...
        return t + ""
    }, s.from = s.convert, Number.from = Number.convert, String.from = String.convert, s.implement({
        hide: function () {
    ...
    var a = this.Type = function (t, n) {
            if (t) {
                ...
                a["is" + t] = i, null != n && (n.prototype.$family = function () {
                    return r
                }.hide())
            }
            return null == n ? null : (n.extend(this), n.$constructor = a, n.prototype.$constructor = n, n)
        },
        u = Object.prototype.toString;
    a.isEnumerable = function (t) {
        return null != t && "number" == typeof t.length && "[object Function]" != u.call(t)
    };
    var c = {},
        l = function (t) {
            var n = e(t.prototype);
        ...
        h = function (t, n) {
            if (!n || !n.$hidden) {
                ...
                null != a && a.$protected || (this.prototype[t] = n), null == this[t] && "function" == e(n) && f.call(this, t, function (t) {
    ...
    p("String", String, ["charAt", "charCodeAt", "concat", "contains", "indexOf", "lastIndexOf", "match", "quote", "replace", "search", "slice", "split", "substr", "substring", "trim", "toLowerCase", "toUpperCase"])("Array", Array, ["pop", "push", "reverse", "shift", "sort", "splice", "unshift", "concat", "join", "slice", "indexOf", "lastIndexOf", "filter", "forEach", "every", "map", "some", "reduce", "reduceRight", "contains"])("Number", Number, ["toExponential", "toFixed", "toLocaleString", "toPrecision"])("Function", s, ["apply", "call", "bind"])("RegExp", RegExp, ["exec", "test"])("Object", Object, ["create", "defineProperty", "defineProperties", "keys", "getPrototypeOf", "getOwnPropertyDescriptor", "getOwnPropertyNames", "preventExtensions", "isExtensible", "seal", "isSealed", "freeze", "isFrozen"])("Date", Date, ["now"]), Object.extend = f.overloadSetter(), Date.extend("now", function () {
        return +new Date
    ...
    function () {
        var t = this.document,
            ...
            n = function (t, e) {
                ...
                return n || (n = t.match(/(opera|ie|firefox|chrome|trident|crios|version)[\s\/:]([\w\d\.]+)?.*?(safari|(?:rv[\s\/:]|version[\s\/:])([\w\d\.]+)|$)/) || [null, "unknown", 0]), "trident" == n[1] ? (n[1] = "ie", n[4] && (n[2] = n[4])) : "crios" == n[1] && (n[1] = "chrome"), e = t.match(/ip(?:ad|od|hone)/) ? "ios" : (t.match(/(?:webos|android)/) || t.match(/mac|win|linux/) || ["other"])[0], "win" == e && (e = "windows"), {
        ...
        if ("ie" == r.name && t.documentMode && (r.version = t.documentMode), r.extend({
                Features: {
                    xpath: !!t.evaluate,
                    air: !!e.runtime,
                ...
                Event: this.Event
            }), this.Window = this.$constructor = new Type("Window", function () {}), this.$family = Function.convert("window").hide(), Window.mirror(function (t, n) {
                e[t] = n
            }), this.Document = t.$constructor = new Type("Document", function () {}), t.$family = Function.convert("document").hide(), Document.mirror(function (e, n) {
                t[e] = n
    ...
    function () {
        ...
        this.Events = new Class({
            ...
            fireEvent: function (e, n, r) {
                e = t(e);
                var i = this.$events[e];
                return i ? (n = Array.convert(n), i.each(function (t) {
    ...
    function () {
        function t(r, i) {
            if (r.$thenableState === o)
                if (r === i) n(r, new TypeError("Tried to resolve a thenable with itself."));
                else if (!i || "object" != typeof i && "function" != typeof i) e(r, i);
            else {
                var s;
                try {
                    s = i.then
        ...
        function e(t, e) {
            t.$thenableState === o && (t.$thenableResult = e, t.$thenableState = a, i(t))
        }

        function n(t, e) {
            t.$thenableState === o && (t.$thenableResult = e, t.$thenableState = u, i(t))
        }

        function r(t) {
            t.$thenableState !== o && (t.$thenableResult = null, t.$thenableState = o)
        }

        function i(t) {
            var e, n = t.$thenableState,
                r = t.$thenableResult,
                i = t.$thenableReactions;
            n === a ? (t.$thenableReactions = [], e = "fulfillHandler") : n == u && (t.$thenableReactions = [], e = "rejectHandler"), e && l(s.pass([r, i, e]))
        }
        ...
        var o = 0,
            ...
            c = Class.Thenable = new Class({
                ...
                then: function (t, e) {
                    "function" != typeof t && (t = "Identity"), "function" != typeof e && (e = "Thrower");
                    var n = new c;
                    return this.$thenableReactions.push({
                        thenable: n,
                        fulfillHandler: t,
                        rejectHandler: e
                    }), this.$thenableState !== o && i(this), n
                },
                "catch": function (t) {
        ...
        var l;
        l = "undefined" != typeof process && "function" == typeof process.nextTick ? process.nextTick : "undefined" != typeof setImmediate ? setImmediate : function (t) {
            setTimeout(t, 0)
        }
    }(),
    function () {
    ...
    function () {
        function t(t, s, o, u, l, f, p, d, m, v, g, y, b, x, E, S) {
            ...
            else if (b) S = S || E, S = S ? S.replace(a, "") : null, k.pseudos || (k.pseudos = []), k.pseudos.push({
                key: b.replace(a, ""),
                value: S,
    ...
    function () {
        ...
        t.search = function (t, e, n, o) {
            ...
            var u, c, l, f, p = this.uniques = {},
                d = !(!n || !n.length),
                m = 9 == t.nodeType;
            if (this.document !== (m ? t : t.ownerDocument) && this.setDocument(t), d)
                ...
                t: if (v) {
                    ...
                    if (g) {
                        if ("#" == g) {
                            ...
                            if (this.idGetsName && l.getAttributeNode("id").nodeValue != y) break t;
                            if (o) return l || null;
                            ...
                            if (t.getElementsByClassName && !this.brokenGEBCN) {
                                ...
                                for (f = t.getElementsByTagName("*"), c = 0; l = f[c++];)
                                    if (className = l.className, className && b.test(className)) {
                                        if (o) return l;
                                        d && p[this.getUID(l)] || a.push(l)
                                    }
                            }
                    ...
                    if (!this.isHTMLDocument || s[e] || this.brokenMixedCaseQSA || this.brokenCheckedQSA && e.indexOf(":checked") > -1 || this.brokenEmptyAttributeQSA && i.test(e) || !m && e.indexOf(",") > -1 || h.disableQSA) break t;
                    var x, E = e,
                        S = t;
                    m || (x = S.getAttribute("id"), slickid = "slickid__", S.setAttribute("id", slickid), E = "#" + slickid + " " + E, t = S.parentNode);
                    try {
                        ...
                        m || (x ? S.setAttribute("id", x) : S.removeAttribute("id"), t = S)
                    }
                    if (this.starSelectsClosedQSA)
                        for (c = 0; l = f[c++];) !(l.nodeName > "@") || d && p[this.getUID(l)] || a.push(l);
                    else
                        for (c = 0; l = f[c++];) d && p[this.getUID(l)] || a.push(l);
            ...
            this.posNTH = {}, this.posNTHLast = {}, this.posNTHType = {}, this.posNTHTypeLast = {}, this.push = !d && (o || 1 == u.length && 1 == u.expressions[0].length) ? this.pushArray : this.pushUID, null == a && (a = []);
            var k, T, C, N, O, A, L, M, $, j, D, P, H, F, R = u.expressions;
            t: for (c = 0; P = R[c]; c++)
                for (k = 0; H = P[k]; k++) {
                    if (N = "combinator:" + H.combinator, !this[N]) continue t;
                    if (O = this.isXMLDocument ? H.tag : H.tag.toUpperCase(), A = H.id, L = H.classList, M = H.classes, $ = H.attributes, j = H.pseudos, F = k === P.length - 1, this.bitUniques = {}, F ? (this.uniques = p, this.found = a) : (this.uniques = {}, this.found = []), 0 === k) {
                        if (this[N](t, O, A, M, $, j, L), o && F && a.length) break t
                    } else if (o && F) {
                        for (T = 0, C = D.length; C > T; T++)
                            if (this[N](D[T], O, A, M, $, j, L), a.length) break t
                    } else
                        for (T = 0, C = D.length; C > T; T++) this[N](D[T], O, A, M, $, j, L);
                    D = this.found
                }
            return (d || u.expressions.length > 1) && this.sort(a), o ? a[0] || null : a
...
Elements.prototype = {
    ...
    function () {
        ...
        d = null, (h || !f) && (i.type = function (t, e) {
            try {
                var n = t.value;
                t.type = e, t.value = n
            } catch (r) {}
        ...
        Element.implement({
            setProperty: function (t, e) {
                ...
                if (n) n(this, e);
                    ...
                    var r;
                    m && (r = this.retrieve("$attributeWhiteList", {})), null == e ? (this.removeAttribute(t), m && delete r[t]) : (this.setAttribute(t, "" + e), m && (r[t] = !0))
                }
                return this
            },
            ...
            hasClass: g ? function (t) {
                return this.classList.contains(t)
            } : function (t) {
                return y(this.className).contains(t)
            },
            addClass: g ? function (t) {
                return y(t).forEach(b, this), this
            } : function (t) {
                return this.className = y(t + " " + this.className).join(" "), this
            },
            removeClass: g ? function (t) {
                return y(t).forEach(x, this), this
            } : function (t) {
                var e = y(this.className);
                return y(t).forEach(e.erase, e), this.className = e.join(" "), this
            },
        ...
        var S = {},
            ...
            T = function (t) {
                ...
                return t.removeEvents && t.removeEvents(), t.clearAttributes && t.clearAttributes(), null != e && (delete S[e], delete w[e]), t
            },
            C = {
                input: "checked",
                option: "selected",
        ...
        if (Element.implement({
                ...
                clone: function (t, e) {
                    ...
                    var n, r = this.cloneNode(t),
                        i = [r],
                        s = [this];
                    for (t && (i.append(Array.convert(r.getElementsByTagName("*"))), s.append(Array.convert(this.getElementsByTagName("*")))), n = i.length; n--;) {
                        var o = i[n],
                            a = s[n];
                ...
                addListener: function (t, e) {
                    return window.attachEvent && !window.addEventListener && (S[Slick.uidOf(this)] = this), this.addEventListener ? this.addEventListener(t, e, !!arguments[2]) : this.attachEvent("on" + t, e), this
                },
            ...
            var N = function () {
                Object.each(S, T), window.CollectGarbage && CollectGarbage(), window.removeListener("unload", N)
            };
        ...
        Element.Properties = {}, Element.Properties.style = {
            ...
            set: function (t) {
                null == t ? t = "" : "array" == typeOf(t) && (t = t.join("")), this.styleSheet && !p ? this.styleSheet.cssText = t : this.innerHTML = t
            },
            erase: function () {
                this.set("html", "")
            }
        ...
        if ($.innerHTML = "<nav></nav>", A = 1 == $.childNodes.length, !A) {
            ...
            for (O = document.createDocumentFragment(), l = j.length; l--;) O.createElement(j[l])
        }
        $ = null, L = Function.attempt(function () {
            var t = document.createElement("table");
            return t.innerHTML = "<tr><td></td></tr>", !0
        });
        var D = document.createElement("tr"),
            P = "<td></td>";
        D.innerHTML = P, M = D.innerHTML == P, D = null, L && M && A || (Element.Properties.html.set = function (t) {
            var e = {
                table: [1, "<table>", "</table>"],
            ...
            return e.thead = e.tfoot = e.tbody,
                function (n) {
                    ...
                    var i = r[0],
                        ...
                        o = s;
                    for (A || O.appendChild(s), s.innerHTML = [r[1], n, r[2]].flatten().join(""); i--;) o = o.firstChild;
                    this.empty().adopt(o.childNodes), A || O.removeChild(s), s = null
                }
        }(Element.Properties.html.set));
        var H = document.createElement("form");
        H.innerHTML = "<select><option>s</option></select>", "s" != H.firstChild.value && (Element.Properties.value = {
            set: function (t) {
                var e = this.get("tag");
        ...
        }), H = null, document.createElement("div").getAttributeNode("id") && (Element.Properties.id = {
            set: function (t) {
        ...
        var t = {},
            ...
            n = this.DOMEvent = new Type("DOMEvent", function (n, r) {
                ...
                if (this.target = document.id(s), 0 == i.indexOf("key")) {
                    ...
                    this.shift && "keypress" == i || (this.key = t[o]), ("keydown" == i || "keyup" == i) && (o > 111 && 124 > o ? this.key = "f" + (o - 111) : o > 95 && 106 > o && (this.key = o - 96)), null == this.key && (this.key = String.fromCharCode(o).toLowerCase())
                    ...
                    if (a = a.compatMode && "CSS1Compat" != a.compatMode ? a.body : a.html, this.page = {
                        ...
                        }, ("DOMMouseScroll" == i || "wheel" == i || "mousewheel" == i) && (this.wheel = e(n)), this.rightClick = 3 == n.which || 2 == n.button, "mouseover" == i || "mouseout" == i || "mouseenter" == i || "mouseleave" == i) {
                        for (var u = "mouseover" == i || "mouseenter" == i, c = n.relatedTarget || n[(u ? "from" : "to") + "Element"]; c && 3 == c.nodeType;) c = c.parentNode;
    ...
    function () {
        Element.Properties.events = {
            ...
            fireEvent: function (t, e, n) {
                ...
                return r && r[t] ? (e = Array.convert(e), r[t].keys.each(function (t) {
    ...
    function () {
        ...
        Element.implement({
            ...
            setStyle: function (t, e) {
                ...
                return this.style[t] = e, ("" == e || null == e) && n && this.style.removeAttribute && b(this.style, t), this
            },
            getStyle: function (t) {
                if ("opacity" == t) return p(this);
                if (t = y("float" == t ? d : t), o && -1 != t.indexOf("borderRadius")) return ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"].map(function (t) {
    ...
    function () {
        var t = this.Fx = new Class({
            ...
            stop: function () {
                return this.isRunning() && (this.time = null, s.call(this, this.options.fps), this.frames == this.frame ? (this.fireEvent("complete", this.subject), this.callChain() || this.fireEvent("chainComplete", this.subject)) : this.fireEvent("stop", this.subject), this.resolve(this.subject === this ? null : this.subject)), this
            },
            cancel: function () {
                return this.isRunning() && (this.time = null, s.call(this, this.options.fps), this.frame = this.frames, this.fireEvent("cancel", this.subject).clearChain(), this.reject(this.subject)), this
            },
            pause: function () {
        ...
        parse: function (t) {
            return t = Function.convert(t)(), t = "string" == typeof t ? t.split(" ") : Array.convert(t), t.map(function (t) {
                t = String(t);
                var e = !1;
        ...
        compute: function (t, e, n) {
            ...
            }), r.$family = Function.convert("fx:css:value"), r
        },
        serve: function (t, e) {
            ...
            n = this.Request = new Class({
                ...
                send: function (t) {
                    ...
                    return e && (h.onloadstart = this.loadstart.bind(this), h.onprogress = this.progress.bind(this)), h.open(o.toUpperCase(), s, this.options.async, this.options.user, this.options.password), this.options.withCredentials && "withCredentials" in h && (h.withCredentials = !0), h.onreadystatechange = this.onStateChange.bind(this), Object.each(this.headers, function (t, e) {
                        ...
                        reason: "send"
                    }), this.fireEvent("request"), h.send(i), this.options.async ? this.options.timeout && (this.timer = this.timeout.delay(this.options.timeout, this)) : this.onStateChange(), this
                },
                cancel: function () {
