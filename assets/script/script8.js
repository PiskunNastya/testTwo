var moolidator_lite_rules = {
    ...
    'cz': {
        'street': {
            'trimming': [],
            'positive': [/^[0-9A-Za-zДљЕ ДЊЕЕЅГќГЃГЌГ‰Е®ГљДЋЕ¤Г“Е‡Г„Г–ГњГџД›ЕЎДЌЕ™ЕѕГЅГЎГ­Г©ЕЇГєДЏЕҐГіЕ€Г¶Г¤Гј ._-]+$/],
            'negative': [/^[\d\s]+$/]
        },
        'tel_number': {
            'trimming': [/\s/g],
    ...
    'hu': {
        'street': {
            'trimming': [],
            'positive': [/^[0-9A-Za-zEЕ CRЕЅГќГЃГЌГ‰UГљDTГ“NГ„Г–ГњOUГџeЕЎcrЕѕГЅГЎГ­Г©uГєdtГіnГ¶Г¤Гјou ._-]+$/],
            'negative': [/^[\d\s]+$/]
        },
        'tel_areacode': {
            'trimming': [/\s/g],
